            ...
            <div className="container mx-auto px-4">
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="lg:col-span-5">
                        <TextReveal as="div" className="mb-8 inline-block">
                        ...
                        <TextReveal as="div" delay={0.2} className="h-px w-24 bg-gold-400 mb-12">
                            <span />
                        </TextReveal>

                        {/* Contact Details Grid */}
                        <div className="space-y-8">
                            <TextReveal as="div" delay={0.3} className="group flex items-start gap-6 p-6 rounded-3xl bg-white border border-olive-100 shadow-sm hover:border-gold-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
                            ...
                            <TextReveal as="div" delay={0.4} className="group flex items-start gap-6 p-6 rounded-3xl bg-white border border-olive-100 shadow-sm hover:border-gold-300 hover:shadow-xl hover:-translate-y-1 transition-all duration-500">
                                <div className="w-12 h-12 rounded-full bg-cream-100 flex items-center justify-center text-olive-600 group-hover:bg-olive-900 group-hover:text-gold-300 transition-colors duration-500 shrink-0">
                    ...
                    <div className="lg:col-span-7 relative">
                        <TextReveal as="div" delay={0.5} className="relative w-full h-full">
                            {/* Decorative Blob */}
        ...
        <Section className="bg-olive-950 py-24 lg:py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <TextReveal as="h2" delay={0.1} className="text-4xl md:text-5xl lg:text-6xl font-serif text-cream-50 leading-tight">
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
                    {[
                        ...
                        >
                            <Link
                                href={item.action}
                                className="group h-full p-8 lg:p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-white/10 hover:border-gold-500/30 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 backdrop-blur-sm flex flex-col items-center text-center"
                            >
    ...
    return (
        <Section className="py-24 lg:py-32 bg-cream-50 overflow-hidden">
            <div className="container mx-auto px-4 max-w-4xl">
                {/* Header */}
                <TextReveal as="div" className="flex items-center gap-4 mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {[
                        ...
                        <TextReveal
                            ...
                            key={index}
                            delay={0.1 + (index * 0.1)}
                            className="p-8 rounded-[2rem] bg-white border border-olive-100 hover:border-gold-200 hover:shadow-lg transition-all duration-500"
                        >
