...
import { WORK_FEATURES } from '@/data';
import { ArrowRight, Wifi, Zap, Armchair, Leaf, Coffee } from 'lucide-react';
import { TextReveal } from '@/components/ui/text-reveal';
import { motion } from 'framer-motion';
import type { PageImage } from '@/lib/settings-store';

const FALLBACK_WORK_IMG: PageImage = {
    url: '/images/workspace.jpg',
    publicId: '',
    alt: 'Premium Thinkery workspace in Calicut',
};

function WorkHeroSection({ mainImage = FALLBACK_WORK_IMG }: { mainImage?: PageImage }) {
    const imgSrc = mainImage.url || FALLBACK_WORK_IMG.url;
    const imgAlt = mainImage.alt || FALLBACK_WORK_IMG.alt;
    return (
            ...
            <div className="container mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="relative order-2 lg:order-1">
                        <TextReveal as="div" delay={0.2} className="relative">
                            ...
                            <motion.div
                                ...
                                className="absolute -top-12 -right-8 w-24 h-24 bg-white rounded-full shadow-xl flex items-center justify-center animate-bounce-slow hidden lg:flex border border-olive-50"
                            >
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <TextReveal as="p" delay={0.3} className="text-xl md:text-2xl text-olive-900/80 font-light leading-relaxed mb-12">
                        ...
                        <div className="mb-12 space-y-4">
                            {[
                                ...
                                <TextReveal key={item.label} as="div" delay={0.4 + (idx * 0.1)} className="flex items-center gap-4 group cursor-default">
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto px-4 relative z-10">
                {WORK_FEATURES.map((feature, index) => (
                    <TextReveal
                        ...
                        key={feature.title}
                        delay={0.2 + (index * 0.1)}
                        className="group p-8 lg:p-10 rounded-[2rem] bg-white/5 border border-white/10 hover:bg-white/10 hover:border-gold-500/30 transition-all duration-500 hover:shadow-[0_0_40px_-10px_rgba(234,179,8,0.1)] hover:-translate-y-1 backdrop-blur-sm"
                    >
        ...
        <Section className="py-24 lg:py-32 overflow-hidden bg-cream-50">
            <div className="container mx-auto px-4">
                ...
                <div className="mb-16 max-w-2xl">
                    <TextReveal as="span" className="text-olive-500 text-xs uppercase tracking-[0.3em] font-bold pl-1 block mb-4">
                        Curated For
                    </TextReveal>
                    <TextReveal as="h2" delay={0.1} className="text-4xl md:text-6xl font-serif text-olive-900 leading-[1.1] mb-6">
                        A space for every <br />
                        <span className="italic text-gold-600">mode of work.</span>
                    </TextReveal>
                    <TextReveal as="p" delay={0.2} className="text-olive-800/70 text-lg font-light max-w-lg">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="max-w-4xl mx-auto border border-gold-500/20 rounded-[3rem] p-8 md:p-12 lg:p-16 relative bg-olive-900/20 backdrop-blur-sm">
                    ...
                    <div className="text-center">
                        <TextReveal as="div" className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-olive-800 border border-olive-700 mb-8 shadow-inner">
                            <span className="w-1.5 h-1.5 rounded-full bg-gold-400 animate-pulse" />
                            <span className="text-gold-200 text-[10px] uppercase tracking-[0.2em] font-bold">Your Productivity Space</span>
                        </TextReveal>

                        <TextReveal as="h2" delay={0.1} className="text-4xl md:text-6xl lg:text-7xl font-serif font-medium text-cream-50 leading-[1.05] mb-8">
                            A café designed for
                        ...
                        <TextReveal as="p" delay={0.2} className="text-olive-200/80 text-lg md:text-xl mb-12 max-w-xl mx-auto font-light leading-relaxed">
...
export function WorkAndMeetContent({ mainImage }: { mainImage?: PageImage }) {
    return (
        <div className="w-full overflow-x-hidden bg-cream-50">
            ...
            <WorkHeroSection mainImage={mainImage} />
            <FeaturesSection />
            <IdealForSection />
            <ProductivityCTA />
        </div >
