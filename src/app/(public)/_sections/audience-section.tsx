        ...
        <Section className="bg-olive-900 text-cream-50 py-32 rounded-t-[4rem] -mt-12 relative z-10 overflow-hidden">
            ...
            <div className="max-w-[90rem] mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 md:mb-24 gap-8">
                    ...
                    <TextReveal as="p" delay={0.3} className="text-olive-200/60 text-lg md:text-xl font-light max-w-md leading-relaxed lg:text-right border-l lg:border-l-0 lg:border-r border-olive-800 pl-6 lg:pl-0 lg:pr-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    <TextReveal as="div" delay={0.2} className="lg:col-span-7 group relative bg-white/[0.05] backdrop-blur-md border border-white/10 p-8 md:p-12 lg:p-14 rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden hover:bg-white/[0.08] hover:border-white/20 transition-all duration-500 shadow-2xl shadow-black/20">
                    ...
                    {/* Remote Workers */}
                    <TextReveal as="div" delay={0.3} className="lg:col-span-5 group relative bg-gradient-to-br from-olive-800/30 to-olive-900/30 backdrop-blur-md border border-white/10 p-8 md:p-12 lg:p-14 rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden hover:border-cream-500/30 transition-all duration-500 shadow-2xl shadow-black/20">
                    ...
                    {/* Founders & Teams */}
                    <TextReveal as="div" delay={0.4} className="lg:col-span-4 group relative bg-white/[0.03] backdrop-blur-sm border border-white/5 p-8 lg:p-10 rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden hover:bg-white/[0.05] transition-colors duration-500">
                        <div className="relative z-10">
                    ...
                    {/* Deep Focus */}
                    <TextReveal as="div" delay={0.45} className="lg:col-span-4 group relative bg-white/[0.03] backdrop-blur-sm border border-white/5 p-8 lg:p-10 rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden hover:bg-white/[0.05] transition-colors duration-500">
                        <div className="relative z-10">
                            <div className="w-14 h-14 rounded-full bg-olive-900/50 border border-white/10 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                    ...
                    {/* Seekers of Calm */}
                    <TextReveal as="div" delay={0.5} className="lg:col-span-4 group relative bg-gradient-to-br from-olive-800/40 to-olive-900/40 backdrop-blur-sm border border-white/5 p-8 lg:p-10 rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden hover:from-olive-800/50 hover:to-olive-900/50 transition-colors duration-500">
                        <div className="relative z-10">
