...
const FALLBACK_HERO_IMG: PageImage = {
    url: '/images/shop-interior.jpg',
    publicId: '',
    alt: 'Thinkery Café interior — sophisticated olive and cream design with brass accents',
};

export function HeroSection({ heroImage = FALLBACK_HERO_IMG }: { heroImage?: PageImage }) {
    const imgSrc = heroImage.url || FALLBACK_HERO_IMG.url;
    const imgAlt = heroImage.alt || FALLBACK_HERO_IMG.alt;
    return (
