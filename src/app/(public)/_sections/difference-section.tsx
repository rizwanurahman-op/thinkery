    ...
    return (
        <Section className="py-32 relative overflow-hidden bg-cream-100">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4">
                ...
                {/* Bento Grid */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 md:gap-8 auto-rows-[minmax(180px,auto)]">

                    {/* 1. QUIET */}
                    <TextReveal as="div" delay={0.2} className="md:col-span-2 lg:col-span-7 lg:row-span-2 rounded-[2rem] md:rounded-[2.5rem] bg-[#2C3318] text-cream-50 p-8 md:p-14 flex flex-col justify-between relative overflow-hidden group hover:ring-1 hover:ring-inset hover:ring-white/10 shadow-2xl shadow-olive-900/10">
                    ...
                    {/* 2. GREENERY */}
                    <TextReveal as="div" delay={0.3} className="md:col-span-1 lg:col-span-5 lg:row-span-1 rounded-[2.5rem] bg-[#E6E8D8] p-8 lg:p-10 relative overflow-hidden group shadow-xl shadow-olive-900/5">
                    ...
                    {/* 3. WIFI */}
                    <TextReveal as="div" delay={0.4} className="md:col-span-1 lg:col-span-5 lg:row-span-1 rounded-[2.5rem] bg-white border border-olive-100 p-8 flex items-center justify-between group hover:shadow-2xl hover:shadow-olive-900/5 transition-shadow duration-500">
                        <div>
                    ...
                    {/* 4. COMFORT */}
                    <TextReveal as="div" delay={0.5} className="md:col-span-2 lg:col-span-12 rounded-[2.5rem] bg-white border border-olive-100 p-8 lg:p-14 flex flex-col md:flex-row items-center gap-8 lg:gap-12 group hover:shadow-2xl hover:shadow-olive-900/5 transition-shadow duration-500">
