...
export function AboutSection({
    bigImage = FALLBACK_BIG,
    smallImage = FALLBACK_SMALL,
}: {
    bigImage?: PageImage;
    smallImage?: PageImage;
}) {
    const bigSrc = bigImage.url || FALLBACK_BIG.url;
    const bigAlt = bigImage.alt || FALLBACK_BIG.alt;
    const smallSrc = smallImage.url || FALLBACK_SMALL.url;
    const smallAlt = smallImage.alt || FALLBACK_SMALL.alt;
    return (
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto px-4">
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute -bottom-6 -right-4 w-40 md:-bottom-4 md:-right-2 md:w-56 lg:-bottom-12 lg:-right-12 lg:w-64 aspect-square bg-cream-50 rounded-3xl p-3 shadow-2xl shadow-olive-900/10 z-20"
                    >
